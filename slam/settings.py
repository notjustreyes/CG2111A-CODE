...
# Auto-stop: distance in mm in front of the robot to check for obstacles
COLLISION_STOP_MM = 500      # 1 green cell ≈ 80mm at zoom 5, adjust to taste
COLLISION_ARC_DEG = 120       # cone width to check (±30 deg from heading)
