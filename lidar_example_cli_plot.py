...
def convert_to_cartesian(angles, distances):
    ...
    for angle, distance in zip(angles, distances):
        ...
        # Hint, Pythagoras' theorem can be used to convert polar to cartesian coordinates
        cartesian_X = distance * -math.sin((VAL_PI/180) * angle)  # REPLACE ME with the correct formula
        cartesian_Y = distance * -math.cos((VAL_PI/180) * angle)  # REPLACE ME with the correct formula
